      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
          ...
          <motion.div
            ...
            className="group"
          >
            <div className="bg-white/5 rounded-sm p-12 h-full border border-white/5 hover:border-cyan-300/30 transition-colors duration-500 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-20 text-9xl font-display text-white select-none">
                01
              </div>
              ...
              <p className="text-gray-400 text-sm mb-8">
                Mercedes-Benz E-Class, BMW 5 Series, or similar
              </p>

              <ul className="space-y-4 mb-10">
                {[
                  "Max 3 Passengers",
                  "Hourly Booking (3hr Min)",
                  "On-board Wi-Fi",
                  "Bottled Water",
                ].map((item, i) => (
                  <li
          ...
          >
            <div className="bg-white/5 rounded-sm p-12 h-full border border-white/5 hover:border-cyan-300/30 transition-colors duration-500 relative overflow-hidden">
              ...
              <p className="text-gray-400 text-sm mb-8">
                Cadillac Escalade, Lincoln Navigator, or similar
              </p>
              ...
              <button
                className="w-full py-4 bg-cyan-300 text-black text-[10px] font-bold uppercase tracking-widest hover:bg-white transition-all"
                onClick={() =>
                  window.open(
                    "https://divinettettey.typeform.com/to/VIH88iPh",
                    "_blank",
